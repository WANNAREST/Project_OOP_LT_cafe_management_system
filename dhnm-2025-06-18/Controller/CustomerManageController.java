...
public class CustomerManageController {
	...
	@FXML
	private TableView<Order_CoffeeShop> orderTableView;
	@FXML
	private TableColumn<Order_CoffeeShop, String> orderIdColumn;
	@FXML
	private TableColumn<Order_CoffeeShop, String> orderDateColumn;
	@FXML
	private TableColumn<Order_CoffeeShop, String> orderTotalColumn;
	...
	private ObservableList<Order_CoffeeShop> customerOrders = FXCollections.observableArrayList();
	...
	private void loadCustomerOrders(String customerId) {
		...
		try (Connection conn = DatabaseConnection.getConnection();
			...
			while (rs.next()) {
				Order_CoffeeShop order = new Order_CoffeeShop(); // Giả sử có constructor mặc định
