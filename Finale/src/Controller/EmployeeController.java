...
public class EmployeeController implements Initializable {
    ...
    @FXML private ImageView employee_imageView;
    ...
    public void employeeSelectData() {
        ...
        if (employeeData.getDob() != null) {
            employee_dob.setValue(employeeData.getDob().toLocalDate());
        }
    }
    ...
    public void employeeImportBtn() {
        ...
        File selectedFile = fileChooser.showOpenDialog(employee_importBtn.getScene().getWindow());

        if (selectedFile != null) {
            imagePath = selectedFile.getAbsolutePath();
            image = new Image(selectedFile.toURI().toString(), 186, 150, false, true);
