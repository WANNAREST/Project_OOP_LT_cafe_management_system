...
public class UserAppController implements Initializable {
    ...
    void showSalaryRecord(ActionEvent event) {
    	...
    	try {
            ...
            e.printStackTrace();
            // Add user-friendly error handling
            System.err.println("Could not load SalaryRecord view: " + e.getMessage());
        }
    }
    ...
    void showInventory(ActionEvent event) {
    	 ...
    	 try {
    		 ...
    		 e.printStackTrace();
             // Add user-friendly error handling
             System.err.println("Could not load inventory detail view: " + e.getMessage());
    	 }
    ...
    public void initialize(URL location, ResourceBundle resources) {
    	//System.out.println("Cướp initialize");
        if(store == null){
    ...
    private void refreshProductGrid() {
        ...
        for (Product product : store.itemsInStore) {
