...
import Controller.employee.CustomerManageController;
import Controller.employee.OrderManagerController;
import Controller.employee.WorkScheduleController;
...
public class StoreController implements Initializable {
	...
	private Controller.CartController cartController;
		...
		for (Product product : store.getItemsInStore()) {
			...
			if (product.getName().toLowerCase().contains(searchText)) {
				try {
					...
					Controller.ProductController controller = fxmlLoader.getController();
