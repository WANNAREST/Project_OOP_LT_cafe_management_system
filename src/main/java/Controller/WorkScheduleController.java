...
public class WorkScheduleController {
	...
	public void openOrderManager() {
	    try {
	        ...
	        if (controller instanceof Controller.OrderManagerController && currentEmployee != null) {
	            Controller.OrderManagerController orderController = (Controller.OrderManagerController) controller;
