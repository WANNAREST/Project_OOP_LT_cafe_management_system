...
public class EmployeeDAO {
	...
	// Method to authenticate employee using phone number and password
	public Employee authenticateEmployee(String phone, String password) throws SQLException {
	    String query = "SELECT u.user_id, u.full_name, u.phone, u.email FROM Users u " +
	                   "JOIN Employees e ON u.user_id = e.employee_id " +
	                   "WHERE u.phone = ? AND u.password = ? AND u.role = 'employee'";
